...
const FF = new SpecialSymbol(String.fromCharCode(0x0C), "", "Print and feed paper 1 lines");
...
export const EscCharacters = [
    STX.symbol, DLE.symbol, ESC.symbol, FS.symbol, GS.symbol, CAN.symbol, FF.symbol, AT.symbol, C_EOT.symbol, C_END.symbol, C_DC4.symbol
]
